								...
								<form id="form-edit-offering">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" name="provisi" class="form-control" style="margin-left: -5%; width: 105%;" id="provisi" placeholder="Provisi" readonly>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="administrasi" style="margin-left: -5%; width: 105%;" id="administrasi" placeholder="administrasi" readonly>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="premi_ass_jiwa" style="margin-left: -5%; width: 105%;"Ass Jiwa" id="premi_ass_jiwa" placeholder="Asuransi jiwa"  readonly>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="premi_ass_kebakaran" style="margin-left: -5%; width: 105%;" id="premi_ass_kebakaran" placeholder="Ass Kebakaran" readonly>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="premi_ass_tlo" style="margin-left: -5%; width: 105%;"Ass tlo" id="premi_ass_tlo" placeholder="Asuransi TLO" readonly>
												</div>
											</div>
										</div>
									</div>
								    ...
								    <div class="col-md-12">
								      <div class="form-group row">
								        ...
								        <div class="col-sm-9">
								          <input type="text" class="form-control" name="premi_ass_kredit" id="premi_ass_kredit" placeholder="Masukan Premi Ass Kredit" style="margin-left: -5%; width: 105%;" readonly/>
								        </div>
								      </div>
								    </div>
								  </div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="tabungan" style="margin-left: -5%; width: 105%;" id="tabungan" placeholder="tabungan" readonly>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="roya" style="margin-left: -5%; width: 105%;" id="roya" placeholder="Roya" readonly>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="pelunasan" style="margin-left: -5%; width: 105%;" id="pelunasan" placeholder="Pelunasan" readonly>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="notaris" style="margin-left: -5%; width: 105%;" id="notaris" placeholder="Notaris" readonly>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="kreditchecking" style="margin-left: -5%; width: 105%;" id="kreditchecking" placeholder="Kredit Checking" readonly>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="fidusia" style="margin-left: -5%; width: 105%;" id="fidusia" placeholder="Fidusia" readonly>
												</div>
											</div>
										</div>
									</div>
								  ...
								  <div class="row">
								    <div class="col-md-12">
								      <div class="form-group row">
								        ...
								        <div class="col-sm-9">
								          <input type="text" class="form-control" name="admin_kredit" id="admin_kredit" placeholder="Masukan Admin Kredit" style="margin-left: -5%; width: 105%;" readonly/>
								        </div>
								      </div>
								    </div>
								  </div>
								  ...
								  <div class="row">
								    <div class="col-md-12">
								      <div class="form-group row">
								        ...
								        <div class="col-sm-9">
								          <input type="text" class="form-control" name="adendum" id="adendum" placeholder="Masukan Adendum" style="margin-left: -5%; width: 105%;" readonly/>
								        </div>
								      </div>
								    </div>
								  </div>
								  ...
								  <div class="row">
								    <div class="col-md-12">
								      <div class="form-group row">
								        <label class="col-sm-3 col-form-label">Biaya Lain Lain</label>
								        <div class="col-sm-9">
								          <input type="text" class="form-control" name="lain_lain" id="lain_lain" placeholder="Masukan Biaya Lain Lain" style="margin-left: -5%; width: 105%;" readonly/>
								        </div>
								      </div>
								    </div>
								  </div>
...
$(document).ready(function () {
	...
	function get_Offering(id_order) {
		$.ajax({
			...
			beforeSend:function() {
				...
				$('#premi_ass_jiwa').val('Sedang Mengambil Data . . . ')
				$('#premi_ass_kebakaran').val('Sedang Mengambil Data . . . ')
				$('#premi_ass_tlo').val('Sedang Mengambil Data . . . ')
				$('#tabungan').val('Sedang Mengambil Data . . . ')
				$('#roya').val('Sedang Mengambil Data . . . ')
				$('#pelunasan').val('Sedang Mengambil Data . . . ')
				$('#notaris').val('Sedang Mengambil Data . . . ')
				$('#kreditchecking').val('Sedang Mengambil Data . . . ')
				$('#fidusia').val('Sedang Mengambil Data . . . ')
				$('#lain_lain').val('Sedang Mengambil Data . . . ')
				$('#no_telp').val('Sedang Mengambil Data . . . ')
				$('#keterangan').val('Sedang Mengambil Data . . . ')
			},
			success:function(res) {
				$.each(res,function (k,v) {
					$('#nomor').val(v.nomor)
					$('#jenis_pinjaman').val(v.jenis_pinjaman)
					$('#suku_bunga').val(v.suku_bunga)
					$('#provisi').val(v.provisi)
					$('#administrasi').val(v.administrasi)
					$('#premi_ass_jiwa').val(v.premi_ass_jiwa)
					$('#premi_ass_kebakaran').val(v.premi_ass_kebakaran)
					$('#premi_ass_tlo').val(v.premi_ass_tlo)
					$('#tabungan').val(v.tabungan)
					$('#roya').val(v.roya)
					$('#pelunasan').val(v.pelunasan)
					$('#notaris').val(v.notaris)
					$('#kreditchecking').val(v.kreditchecking)
					$('#fidusia').val(v.fidusia)
					$('#lain_lain').val(v.lain_lain)
					$('#no_telp').val(v.no_telp)
	...
	function get_biaya(id_order) {
		$.ajax({
			...
			dataType:'JSON',
			beforeSend:function() {
				$('#premi_ass_kredit').val('Sedang Mengambil Data . . . ')
				$('#admin_kredit').val('Sedang Mengambil Data . . . ')
				$('#adendum').val('Sedang Mengambil Data . . . ')
				$('#pelunasan').val('Sedang Mengambil Data . . . ')
			},
			success:function(res) {
				$.each(res,function (k,v) {
					$('#premi_ass_kredit').val(v.premi_ass_kredit)
					$('#admin_kredit').val(v.admin_kredit)
					$('#adendum').val(v.adendum)
					$('#pelunasan').val(v.pelunasan)
				})
			},
			error:function (xhr, status, error) {
