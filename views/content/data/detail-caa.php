			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
                  ...
                  <p style="color:grey;margin-top:12px;margin-left:5px;">Rekomendasi : </p>
				      		<input type="text" name="plafond" class="form-control" onkeydown="return numbersonly(this, event)" onkeyup="javascript:tandaPemisahTitik(this)" placeholder="Masukan Plafond yang di setujui" min="5">
                  ...
                  <p style="color:grey;margin-top:12px;margin-left:5px;">Alasan : </p>
				     			<textarea type="text" name="alasan" class="form-control" placeholder="Masukan alasan persetujuan" style="height:85px;margin-top:3px;"></textarea>
                  <p style="color:grey;margin-top:12px;margin-left:5px;">Syarat : </p>
				     			<textarea type="text" name="syarat" class="form-control" placeholder="Masukan syarat persetujuan" style="height:85px;margin-top:3px;"></textarea>
                  <p style="color:grey;margin-top:12px;margin-left:5px;">Catatan : </p>
				     			<textarea type="text" name="notes" class="form-control" placeholder="Masukan catatan persetujuan" style="height:155px;margin-top:3px;"></textarea>
				      </div>
				      <div class="modal-footer">
				        <button type="button" class="btn btn-success" id="btn-approval"><i class="mdi mdi-checkbox-marked-circle"></i>Approve</button>
				      </div>
			      </form>
			    </div>
			  </div>
			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <p>Calon Debitur &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <mcd class="m_cd"></mcd></p>
			      <form id="form-reject">
				      <div style="padding:2%;">
				      		<input type="hidden" name="id_order" class="m_id_order" value="">
				      		<input type="hidden" name="ao_to_email" class="ao_to_email" value="">
				      		...
				      		<input type="hidden" name="nik_to_email" class="nik_to_email" value="">
				      		<input type="hidden" name="plafond_to_email" class="plafond_to_email" value="">
				     			<textarea type="text" name="notes" class="form-control" placeholder="Masukan catatan penolakan" style="height:155px;margin-top:3px;"></textarea>
				      </div>
				      <div class="modal-footer">
				        <button type="button" class="btn btn-danger" id="btn-reject"><i class="mdi mdi-close-circle"></i>Reject</button>
				      </div>
			      </form>
			    </div>
			  </div>
