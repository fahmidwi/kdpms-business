...
<div class="row">
  <div class="col-lg-12">
    ...
    <div class="card" style="margin-top: 1%">
      <div class="card-body">
        <h4 style="">Form Memo Kredit Ca</h4>
        <hr><br>
        ...
        <form class="form-sample" id="form-memo-kredit-ca">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="nama_calon_debitur"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Calon Debitur" id="nama_calon_debitur"
                    readonly>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" style="margin-left: -5%; width: 105%;" name="no_aplikasi_ca"
                    placeholder="Masuka Nomor Aplikasi" id="no_aplikasi_ca" readonly />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" style="margin-left: -5%; width: 105%;" id="jaminan_utama_ca"
                    readonly />
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" style="margin-left:15%;width:85%;" id="sumber_informasi_ca"
                    readonly />
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" name="jml_tanggungan" class="form-control" id="jml_tanggungan"
                    style="margin-left: 15%; width: 80%;" placeholder="Masukan jumlah tanggungan">
                </div>
              </div>
            </div>
            <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="alamat_domisili_ca" id="alamat_domisili_ca"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Alamat Domisili" readonly></textarea>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input class="form-control" type="text" name="rt_domisili" id="rt_domisili" placeholder="Masukan RT"
                    style="margin-left: 15%; width: 80%;" readonly />
                </div>
              </div>
            </div>
            <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input class="form-control" type="text" placeholder="Masukan Pekerjaan Debitur" id="pekerjaan_debitur"
                    style="margin-left: -5%; width: 105%;" name="pekerjaan_debitur" readonly="" />
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" style="margin-left: 15%; width: 80%;" name="nama_tempat_kerja"
                    placeholder="Masukan Nama Tempat Kerja" id="nama_tempat_kerja" class="form-control">
                </div>
              </div>
            </div>
            <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="jenis_usaha_debitur" id="jenis_usaha_debitur"
                    placeholder="Masukan Jenis Usaha Debitur" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="alamat_usaha_debitur" id="alamat_usaha_debitur"
                    placeholder="Masukan Alamat Usaha Debitur" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="masa_kerja_debitur" id="masa_kerja_debitur"
                    placeholder="Masukan Masa Kerja Debitur" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="number" class="form-control" name="no_telp_kerja_debitur" id="no_telp_kerja_debitur"
                    placeholder="Masukan Nomor Telepon Kerja Debitur" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input class="form-control" type="text" name="usaha_debitur" placeholder="Masukan Usaha Debitur"
                    id="usaha_debitur" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" style="margin-left: 15%; width: 80%;" name="nama_tempat_usaha"
                    placeholder="Masukan Nama Tempat Kerja" id="nama_tempat_usaha" class="form-control">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">Posisi</label>
                <div class="col-sm-9">
                  <input type="text" placeholder="Masukan Posisi" id="posisi" class="form-control" value="PEMILIK USAHA"
                    readonly>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">Alamat Usaha Debitur</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="alamat_tempat_usaha" id="alamat_tempat_usaha"
                    placeholder="Masukan Alamat Usaha Debitur" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="masa_usaha" id="masa_usaha"
                    placeholder="Masukan Masa Usaha Debitur" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="no_telp_usaha" id="no_telp_usaha"
                    placeholder="Masukan Nomor Telepon Usaha Debitur" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <select class="form-control" name="tempat_usaha" id="tempat_usaha"
                    style="margin-left: -5%; width: 105%;">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="pengeluaran_lainnya" id="pengeluaran_lainnya"
                    onkeydown="return numbersonly(this, event)" onkeyup="javascript:tandaPemisahTitik(this)"
                    placeholder="Masukan Pengeluaran Lainnya" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="pendapatan_tunai" id="pendapatan_tunai"
                    onkeydown="return numbersonly(this, event)" onkeyup="javascript:tandaPemisahTitik(this)"
                    placeholder="Masukan Pendapatan tunai" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="pendapatan_kredit" id="pendapatan_kredit"
                    onkeydown="return numbersonly(this, event)" onkeyup="javascript:tandaPemisahTitik(this)"
                    placeholder="Masukan Pendapatan kredit" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="pengeluaran_sewa" id="pengeluaran_sewa"
                    onkeydown="return numbersonly(this, event)" onkeyup="javascript:tandaPemisahTitik(this)"
                    placeholder="Masukan Pengeluaran Sewa" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="pengeluaran_belanja" id="pengeluaran_belanja"
                    onkeydown="return numbersonly(this, event)" onkeyup="javascript:tandaPemisahTitik(this)"
                    placeholder="Masukan Pengeluaran Belanja" style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input class="form-control" type="text" name="pengeluaran_gaji_pegawai" id="pengeluaran_gaji_pegawai"
                    style="margin-left: -5%; width: 105%;" onkeydown="return numbersonly(this, event)"
                    onkeyup="javascript:tandaPemisahTitik(this)" placeholder="Masukan Pengeluaran Gaji Pegawai">
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input class="form-control" type="text" name="angsuran_lain_usaha" id="angsuran_lain_usaha"
                    style="margin-left: -5%; width: 105%;" onkeydown="return numbersonly(this, event)"
                    onkeyup="javascript:tandaPemisahTitik(this)" placeholder="Masukan Angsuran Lain Usaha">
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input class="form-control" type="text" name="pengeluaran_lain_usaha" id="pengeluaran_lain_usaha"
                    style="margin-left: -5%; width: 105%;" onkeydown="return numbersonly(this, event)"
                    onkeyup="javascript:tandaPemisahTitik(this)" placeholder="Masukan pengeluaran Lain Usaha">
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="pengeluaran_telp_listrik_air"
                    id="pengeluaran_telp_listrik_air" style="margin-left: -5%; width: 105%;"
                    onkeydown="return numbersonly(this, event)" onkeyup="javascript:tandaPemisahTitik(this)"
                    placeholder="Masukan Pengeluaran Telp Listrik Air">
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="ktp_cln_debitur" id="ktp_cln_debitur" value="1">
                    <p>Sudah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="ktp_cln_debitur" id="ktp_cln_debitur" value="0"
                      checked>
                    <p>Belum</p>
                  </div>
                </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="ktp_pasangan" id="ktp_pasangan" value="1">
                    <p>Sudah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="ktp_pasangan" id="ktp_pasangan" value="0"
                      checked>
                    <p>Belum</p>
                  </div>
                </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kartu_keluarga" id="kartu_keluarga" value="1">
                    <p>Sudah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kartu_keluarga" id="kartu_keluarga" value="0"
                      checked>
                    <p>Belum</p>
                  </div>
                </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="surat_nikah" id="surat_nikah" value="1">
                    <p>Sudah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="surat_nikah" id="surat_nikah" value="0" checked>
                    <p>Belum</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="surat_cerai" id="surat_cerai" value="1">
                    <p>Sudah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="surat_cerai" id="surat_cerai" value="0" checked>
                    <p>Belum</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="sttp_pbb" id="sttp_pbb" value="1">
                    <p>Sudah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="sttp_pbb" id="sttp_pbb" value="0" checked>
                    <p>Belum</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="sertifikat_or_bpkb" id="sertifikat_or_bpkb"
                      value="1">
                    <p>Sudah</p>
                  </div>
                </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="imb" id="imb" value="1">
                    <p>Sudah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="imb" id="imb" value="0" checked>
                    <p>Belum</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="slip_gaji" id="slip_gaji" value="1">
                    <p>Sudah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="slip_gaji" id="slip_gaji" value="0" checked>
                    <p>Belum</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="rekening_tabungan" id="rekening_tabungan"
                      value="1">
                    <p>Sudah</p>
                  </div>
                </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="data_penjamin" id="data_penjamin" value="1">
                    <p>Sudah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="data_penjamin" id="data_penjamin" value="0"
                      checked>
                    <p>Belum</p>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="catatan" id="catatan" style="margin-left: -5%; width: 105%;"
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="visit_cln_debitur" id="visit_cln_debitur"
                      value="1">
                    <p>Sudah</p>
                  </div>
                </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="visit_pasangan" id="visit_pasangan" value="1">
                    <p>Sudah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="visit_pasangan" id="visit_pasangan" value="0"
                      checked>
                    <p>Belum</p>
                  </div>
                </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="visit_penjamin" id="visit_penjamin" value="1">
                    <p>Sudah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="visit_penjamin" id="visit_penjamin" value="0"
                      checked>
                    <p>Belum</p>
                  </div>
                </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="visit_tmpt_tinggal" id="visit_tmpt_tinggal"
                      value="1">
                    <p>Sesuai Data</p>
                  </div>
                </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="visit_jaminan" id="visit_jaminan" value="1">
                    <p>Sesuai Data</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="visit_jaminan" id="visit_jaminan" value="0"
                      checked>
                    <p>Tidak Sesuai</p>
                  </div>
                </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="visit_usaha" id="visit_usaha" value="1">
                    <p>Sesuai Data</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="visit_usaha" id="visit_usaha" value="0" checked>
                    <p>Tidak Sesuai</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="cek_lingkungan" id="cek_lingkungan" value="1">
                    <p>Sesuai Data</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="cek_lingkungan" id="cek_lingkungan" value="0"
                      checked>
                    <p>Tidak Sesuai</p>
                  </div>
                </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="alamat_domisili" id="alamat_domisili" value="1">
                    <p>Sesuai KTP</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="alamat_domisili" id="alamat_domisili" value="0"
                      checked>
                    <p>Tidak Sesuai KTP</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="stnk" id="stnk" value="ada" checked>
                    <p>ada</p>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="stnk" id="stnk" value="tidak ada">
                    <p>tidak ada</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="stnk1" id="stnk" value="berlaku" checked>
                    <p>berlaku</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="stnk1" id="stnk" value="habis">
                    <p>habis</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="notes_pajak" id="notes_pajak" value="ada"
                      checked>
                    <p>ada</p>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="notes_pajak" id="notes_pajak" value="tidak ada">
                    <p>tidak ada</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="notes_pajak1" id="notes_pajak" value="berlaku"
                      checked>
                    <p>berlaku</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="notes_pajak1" id="notes_pajak" value="habis">
                    <p>habis</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="trayek" id="trayek" value="ada" checked>
                    <p>ada</p>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="trayek" id="trayek" value="tidak ada">
                    <p>tidak ada</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="trayek1" id="trayek" value="berlaku" checked>
                    <p>berlaku</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="trayek1" id="trayek" value="habis">
                    <p>habis</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="bpkb" id="bpkb" value="ada" checked>
                    <p>ada</p>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="bpkb" id="bpkb" value="tidak ada">
                    <p>tidak ada</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="bpkb1" id="bpkb" value="sah" checked>
                    <p>sah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="bpkb1" id="bpkb" value="diragukan">
                    <p>diragukan</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="faktur" id="faktur" value="ada" checked>
                    <p>ada</p>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="faktur" id="faktur" value="tidak ada">
                    <p>tidak ada</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="faktur1" id="faktur" value="sah" checked>
                    <p>sah</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="faktur1" id="faktur" value="diragukan">
                    <p>diragukan</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kwitansi_blangko" id="kwitansi_blangko"
                      value="ada" checked>
                    <p>ada</p>
                  </div>
                </div>
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kwitansi_blangko1" id="kwitansi_blangko"
                      value="sah" checked>
                    <p>sah</p>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="date" class="form-control" name="masa_berlaku_stnk" id="masa_berlaku_stnk"
                    style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="date" class="form-control" name="masa_berlaku_pajak" id="masa_berlaku_pajak"
                    style="margin-left: -5%; width: 105%;" />
                </div>
              </div>
            </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="chasis" id="chasis" value="Baik" checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="chasis" id="chasis" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="chasis" id="chasis" value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="chasis" id="chasis" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="body" id="body" value="Baik" checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="body" id="body" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="body" id="body" value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="body" id="body" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kabin" id="kabin" value="Baik" checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kabin" id="kabin" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kabin" id="kabin" value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kabin" id="kabin" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="flapon" id="flapon" value="Baik" checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="flapon" id="flapon" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="flapon" id="flapon" value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="flapon" id="flapon" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="dashboard" id="dashboard" value="Baik" checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="dashboard" id="dashboard" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="dashboard" id="dashboard" value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="dashboard" id="dashboard" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="dek_landasan" id="dek_landasan" value="Baik"
                      checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="dek_landasan" id="dek_landasan" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="dek_landasan" id="dek_landasan"
                      value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="dek_landasan" id="dek_landasan" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="ban" id="ban" value="Baik" checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="ban" id="ban" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="ban" id="ban" value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="ban" id="ban" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="velg" id="velg" value="Baik" checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="velg" id="velg" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="velg" id="velg" value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="velg" id="velg" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="jok" id="jok" value="Baik" checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="jok" id="jok" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="jok" id="jok" value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="jok" id="jok" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="cat" id="cat" value="Baik" checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="cat" id="cat" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="cat" id="cat" value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="cat" id="cat" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="lampu_lampu" id="lampu_lampu" value="Baik"
                      checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="lampu_lampu" id="lampu_lampu" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="lampu_lampu" id="lampu_lampu"
                      value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="lampu_lampu" id="lampu_lampu" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="klakson" id="klakson" value="Baik" checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="klakson" id="klakson" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="klakson" id="klakson" value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="klakson" id="klakson" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="speedometer" id="speedometer" value="Baik"
                      checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="speedometer" id="speedometer" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="speedometer" id="speedometer"
                      value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="speedometer" id="speedometer" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kaca_spion" id="kaca_spion" value="Baik" checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kaca_spion" id="kaca_spion" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kaca_spion" id="kaca_spion" value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kaca_spion" id="kaca_spion" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kunci_kontak" id="kunci_kontak" value="Baik"
                      checked>
                    <p>Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kunci_kontak" id="kunci_kontak" value="Cukup">
                    <p>Cukup</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kunci_kontak" id="kunci_kontak"
                      value="Kurang Baik">
                    <p>Kurang Baik</p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-radio">
                    <input type="radio" class="form-check-input" name="kunci_kontak" id="kunci_kontak" value="Rusak">
                    <p>Rusak</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="kondisi_mesin_hidup" id="kondisi_mesin_hidup"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Kondisi Mesin"></textarea>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="perlengkapan_yang_ada" id="perlengkapan_yang_ada"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Perlengkapan"></textarea>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" style="margin-left: 15%; width: 80%;" name="sumber1"
                    placeholder="Masukan Informasi" id="sumber1" class="form-control">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" name="harga1" onkeydown="return numbersonly(this, event)"
                    onkeyup="javascript:tandaPemisahTitik(this)" placeholder="Masukan harga1" id="harga1"
                    class="form-control">
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" style="margin-left: 15%; width: 80%;" name="sumber2"
                    placeholder="Masukan Informasi" id="sumber2" class="form-control">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" name="harga2" onkeydown="return numbersonly(this, event)"
                    onkeyup="javascript:tandaPemisahTitik(this)" placeholder="Masukan harga" id="harga2"
                    class="form-control">
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="kesimpulan_penilaian" id="kesimpulan_penilaian"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Subject" id="Subject"></textarea>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="team_survey" id="team_survey"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Team Survey"></textarea>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="penyimpangan" id="penyimpangan"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Penyimpangan"></textarea>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="vertifikasi_data_debitur" id="vertifikasi_data_debitur_ca"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Verivikasi Data Debitur"></textarea>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="vertifikasi_penjamin" id="vertifikasi_penjamin"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Verivikasi Penjamin"></textarea>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="vertifikasi_jaminan" id="vertifikasi_jaminan"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Verivikasi jaminan"></textarea>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="analisa_kredit_checking" id="analisa_kredit_checking"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Analisa Kredit Checking"></textarea>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="ket_calon_debitur" id="ket_calon_debitur_ca"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Keterangan Calon Debitur"></textarea>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="comment_analisa" id="comment_analisa"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Komentar Analisa"></textarea>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="hasil_cek_lingk" id="hasil_cek_lingk"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Komentar Analisa"></textarea>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="hasil_cek_aspek_kuantitatif" id="hasil_cek_aspek_kuantitatif"
                    style="margin-left: -5%; width: 105%;" placeholder="Masukan Hasil Cek Aspek Kuantitatif"></textarea>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="Subject" id="Subject" style="margin-left: -5%; width: 105%;"
                    placeholder="Masukan Subject" id="Subject"></textarea>
                </div>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="file" class="form-control" name="foto_jaminan[]" id="foto_jaminan"
                    style="margin-left: -5%; width: 105%;" multiple>
                </div>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="file" class="form-control" name="lampiran_caa[]" id="lampiran"
                    style="margin-left: -5%; width: 105%;" multiple>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control" name="realisasi" id="realisasi_req"
                    style="margin-left: -5%; width: 105%;" onkeydown="return numbersonly(this, event)"
                    onkeyup="javascript:tandaPemisahTitik(this)" placeholder="Rekomendasi">
                </div>
          ...
          <button type="submit" class="btn btn-primary btn-fw" style="width: 100%;" id="simpan-memo-ca">Simpan Memo
            Kredit CA</button>&nbsp;
        </form>
      </div>
    </div>
  ...
  $(document).ready(function() {
    ...
    $('#form-memo-kredit-ca').submit(function(e) {
      ...
      // if (jml_tanggungan && alamat_sekarang && nama_tempat_kerja && posisi && jenis_usaha_debitur &&
      //   alamat_usaha_debitur && masa_kerja_debitur && no_telp_kerja_debitur && pengeluaran_lainnya &&
      //   pendapatan_tunai && pendapatan_kredit && pengeluaran_sewa && pengeluaran_belanja &&
      //   pengeluaran_gaji_pegawai && angsuran_lain_usaha && pengeluaran_lain_usaha &&
      //   pengeluaran_telp_listrik_air && catatan && masa_berlaku_stnk && masa_berlaku_pajak &&
      //   kondisi_mesin_hidup && perlengkapan_yang_ada && sumber1 && harga1 && sumber2 && harga2 &&
      //   kesimpulan_penilaian && team_survey && penyimpangan && vertifikasi_data_debitur &&
      //   vertifikasi_penjamin && vertifikasi_jaminan && analisa_kredit_checking && ket_calon_debitur &&
      //   comment_analisa && hasil_cek_lingk && hasil_cek_aspek_kuantitatif && Subject && foto_jaminan &&
      //   lampiran_caa) {
      //   addMemoCa(data)
      // }
      addMemoCa(data)
    ...
    function addMemoCa(data) {
      $.ajax({
        type: 'POST',
        url: url + 'Home/AddMemoKreditCaKendaraan/' + ao_to_email + '/' + name_to_email + '/' + nik_to_email +
          '/' + plafond_to_email,
        data: data,
        dataType: 'JSON',
        processData: false,
        ...
        beforeSend: function() {
          ...
          $('#simpan-memo-ca').html(
            '<i class="mdi mdi-18px mdi-spin mdi-loading"></i> Sedang mengirim data . . .');
        },
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $.each(data, function(key, val) {
            ...
            $('#alamat').html('<p>' + val.alamat + ', RT.' + val.rt + ' RW.' + val.rw + ', KELURAHAN.' +
              val.Kelurahan + ', KECAMATAN.' + val.Kecamatan + ', ' + val.Kotakab + ', PROVINSI ' + val
              .propinsi + '</p>')
          })
        },
        error: function(xhr, status, error) {
        ...
        success: function(res) {
          ...
          $.each(res, function(v, k) {
            if (k.verifikasi == 0) {
              ...
              verifikasi_date = 'belum terverifikasi'
              $('#divButvk').html(
                '<a href="javascript:void(0)" class="btn btn-success" style="width: 100%" id="buttonVerifKredit"><i class="mdi mdi-verified"></i>&nbsp;Verifikasi Kredit</a>'
              )
            } else {
              $('#divButvk').html('')
            ...
            if (k.status == 'WAITING') {
              status = '<label class="badge badge-warning">' + k.status + '&nbsp;&nbsp;(' + changeDate(k
                .proses_date) + ')</label>'

            } else if (k.status == 'ON PROGRESS') {
              status = '<label class="badge badge-success">' + k.status + '&nbsp;&nbsp;(' + changeDate(k
                .proses_date) + ')</label>'

            } else if (k.status == 'DONE') {
              status = '<label class="badge badge-primary">' + k.status + '&nbsp;&nbsp;(' + changeDate(k
                .proses_date) + ')</label>'

            } else if (k.status == 'PENDING') {

              status = '<label class="badge badge-dark">' + k.status + '&nbsp;&nbsp;(' + changeDate(k
                .proses_date) + ')</label>'
            }
            $('idk').html(k.id)
        ...
        success: function(res) {
          ...
          $.each(res, function(v, k) {
            ...
            $('#pengeluaran_transportasi').html('<p> Rp. ' + FormatRupiah(k.pengeluaran_transportasi) +
              '</p>')
            $('#pengeluaran_pendidikan').html('<p> Rp. ' + FormatRupiah(k.pengeluaran_pendidikan) +
              '</p>')
        ...
        success: function(res) {
          ...
          if (res.amount == 0) {
            ...
            $.each(res, function(v, k) {
              ...
              $('#alamat_k').val(k.alamat_bpkb.toUpperCase() + ' KECAMATAN ' + k.kecamatan_bpkb
                .toUpperCase() + ' KELURAHAN ' + k.kelurahan_bpkb.toUpperCase() + ' KOTA/KAB ' + k
                .kota_bpkb.toUpperCase())
        ...
        success: function(data) {
          ...
          $.each(data, function(index, value) {
            if (kepRumah == value.kode_kepemilikan) {
              html += '<option value="' + value.kode_kepemilikan + '" selected>' + value
                .nama_kepemilikan + '</option>'
            } else {
              html += '<option value="' + value.kode_kepemilikan + '">' + value.nama_kepemilikan +
                '</option>'
            }
          })
          $('#opt-kepemilikan-rumah-cn').html(
            '<select class="form-control" name="status_rumah" disabled style="margin-left: 15%; width: 80%;><option value="null" >Pilih</option>' +
            html + '</select>')
        }
      })
    }
    ...
    function getPropinsi(propinsi) {
      $.ajax({
        ...
        success: function(data) {
          ...
          $('#opt-propinsi').html(
            '<select class="form-control" name="propinsi_id_domisili" id="selectPropinsi" disabled style="margin-left: 15%; width: 80%;><option value="null">Pilih</Option>' +
            html +
            '</select>')
        }
      })
    ...
    function getKabKota(kotakab, propinsi_id) {
      $.ajax({
        ...
        success: function(data) {
          ...
          $('#opt-kotakab').html(
            '<select class="form-control" name="kotakab_id_domisili" id="selectKabkota" disabled><option value="null">Pilih</Option>' +
            html + '</select>')
        }
      })
    }
    ...
    function getKecamatan(kecamatan, kotakab_id) {
      $.ajax({
        ...
        success: function(data) {
          ...
          $('#opt-kecamatan').html(
            '<select class="form-control" name="kecamatan_id_domisili" id="selectKecamatan" disabled style="margin-left: 15%; width: 80%;><option value="null">Pilih</Option>' +
            html + '</select>')
        }
      })
    }
    ...
    function getKelurahan(kelurahan, kecamatan_id) {
      $.ajax({
        ...
        success: function(data) {
          ...
          $('#opt-kelurahan').html(
            '<select class="form-control" name="kelurahan_id_domisili" id="selectKelurahan" disabled><option value="null">Pilih</Option>' +
            html + '</select>')
        }
      })
    }
