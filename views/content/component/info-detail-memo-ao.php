        ...
        <div class="card">
          <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Nama Sekolah Anak</label>
                    <div class="col-sm-8" style="border-bottom: 1px solid grey">
                    <div id="nama_sekolah_anak">
                    </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Alamat Sekolah Anak</label>
                    <div class="col-sm-8" style="border-bottom: 1px solid grey">
                    <div id="alamat_sekolah_anak">
                    </div>
                    </div>
                  </div>
                </div>
                ...
                <!-- <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Rekomdasi AO</label>
                    <div class="col-sm-8" style="border-bottom: 1px solid grey">
                    <div id="realisasi">
                    </div>
                    </div>
                ...
                <!-- <div class="col-md-12 d_shm">
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">No SHM</label>
                    <div class="col-sm-8" style="border-bottom: 1px solid grey">
                    <div id="no_shm">
                    </div>
                    </div>
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">IMB</label>
                    <div class="col-sm-8" style="border-bottom: 1px solid grey">
                    <div id="imb">
                    </div>
                    </div>
